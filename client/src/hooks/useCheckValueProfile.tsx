import { type StatDataState, type StoreTypes, type Stats, type StatsMap, type LoadoutState, type AplyedValue, type ProfileDataState, type ProfileState } from '../types/typesStore.tsx'
